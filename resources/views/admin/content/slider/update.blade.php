...
@section('content')
    ...
    <form id="updateForm" role="form" method="post" action="{{ route('slider.update', $slide->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="col-md-6">
            <!-- Default box -->
            <div class="card">
                <div class="card-header">
                    <a href="{{route('slider.index')}}" class="float-left mr-2"><i class="fas fa-arrow-alt-circle-left"></i></a>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input class="custom-control-input" type="checkbox" id="active" name="active" {{($slide->active == 1) ? 'checked=""' : ''}}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control @error('sort') is-invalid @enderror" id="sort"  name="sort" value="{{$slide->sort}}">
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="img" value="{{$slide->img}}" id="img">
...
@section('scripts')
    <script>
        ...
        function RemoveImgFile(path){
            $.ajax(
                {
                    url: "/admin/slider-img-update-remove",
                    type: 'POST',
                    data: {
