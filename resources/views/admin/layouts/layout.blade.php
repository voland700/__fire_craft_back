...
<head>
    ...
    <title>@yield('title','Админ панель - Fire-Craft.Ru')</title>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{route('clear.cash')}}" class="nav-link" id="CashClean">Cash</a>
            </li>
        </ul
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            ...
            <img src="{{asset("/assets/admin/img/logo.svg")}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">




            <span class="brand-text font-weight-light">Fire-Craft.Ru</span>
        </a>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">@yield('h1','Редактирование данных')</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        @yield('breadcrumbs')
                    </div>
